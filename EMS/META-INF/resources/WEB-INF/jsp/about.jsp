...
<!-- Preloader -->
    ...
    <section class="breadcrumb-area bg-img bg-gradient-overlay jarallax" style="background-image: url(/images/bg-img/27.jpg);">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="single-we-offer-content text-center wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <div class="offer-icon">
                            <img src="/images/core-img/icon.png" alt="">
                        </div>
                        <h5>Conference</h5>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="single-we-offer-content text-center wow fadeInUp" data-wow-delay="0.3s">
                        <!-- Icon -->
                        <div class="offer-icon">
                            <img src="/images/core-img/icon-2.png" alt="">
                        </div>
                        <h5>Workshops</h5>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="single-we-offer-content text-center wow fadeInUp" data-wow-delay="0.3s">
                        <!-- Icon -->
                        <div class="offer-icon">
                            <img src="/images/core-img/icon-3.png" alt="">
                        </div>
                        <h5>Coffee Breaks</h5>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="single-we-offer-content text-center wow fadeInUp" data-wow-delay="0.3s">
                        <!-- Icon -->
                        <div class="offer-icon">
                            <img src="/images/core-img/icon-4.png" alt="">
                        </div>
                        <h5>Events</h5>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <div class="speaker-single-thumb">
                            <img src="/images/bg-img/Bakthavathsalam 2.jpg" alt="">
                        </div>
                        <!-- Social Info -->
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Thumb -->
                        <div class="speaker-single-thumb">
                            <img src="/images/bg-img/jaideep-ch.jpg" alt="">
                        </div>
                        <!-- Social Info -->
                        <div class="social-info">
                            <a href="#"><i class="zmdi zmdi-facebook"></i></a>
                        ...
                        <!-- Info -->
                        <div class="speaker-info">
                            <h5>Jaideep Chatterjee</h5>
                            <p>Vice President – SAP Practice</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Thumb -->
                        <div class="speaker-single-thumb">
                            <img src="/images/bg-img/sriram.jpg" alt="">
                        </div>
                        <!-- Social Info -->
                        <div class="social-info">
                            <a href="#"><i class="zmdi zmdi-facebook"></i></a>
                        ...
                        <!-- Info -->
                        <div class="speaker-info">
                            <h5>Sriram Narayan</h5>
                            <p>Director - RPA Sales</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="single-gallery-thumb wow fadeInUp" data-wow-delay="300ms">
                        <img src="/images/bg-img/think hack1.jpg" alt="">
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-3">
                    <div class="single-gallery-thumb wow fadeInUp" data-wow-delay="300ms">
                        <img src="/images/bg-img/think hack 2.jpg" alt="">
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="single-gallery-thumb wow fadeInUp" data-wow-delay="300ms">
                        <img src="/images/bg-img/g3.jpg" alt="">
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="single-gallery-thumb wow fadeInUp" data-wow-delay="300ms">
                        <img src="/images/bg-img/kgisl1.jpg" alt="">
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-3">
                    <div class="single-gallery-thumb wow fadeInUp" data-wow-delay="300ms">
                        <img src="/images/bg-img/think hack 5.jpg" alt="">
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-3">
                    <div class="single-gallery-thumb wow fadeInUp" data-wow-delay="300ms">
                        <img src="/images/bg-img/think hack 4.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget mb-60">
                            <!-- Footer Logo -->
                            <a href="#" class="footer-logo"><img src="/images/core-img/teamlogo.png" alt=""></a>
